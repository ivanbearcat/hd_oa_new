    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sn_mainboard', models.CharField(blank=True, max_length=32, null=True, verbose_name='主板序列号')),
                ('sn_BIOS', models.CharField(blank=True, max_length=32, null=True, verbose_name='BIOS序列号')),
                ...
                ('is_use', models.CharField(blank=True, choices=[('是', '是'), ('否', '否')], max_length=2, null=True, verbose_name='使用情况')),
                ...
                ('status', models.CharField(choices=[('使用中', '使用中'), ('库存', '库存'), ('出库', '出库'), ('报废', '报废'), ('损坏', '损坏'), ('出库审批', '出库审批'), ('报废审批', '报废审批')], default='库存', max_length=16, verbose_name='状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('info', models.TextField(blank=True, max_length=1024, null=True, verbose_name='备注')),
